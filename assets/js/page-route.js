  ...
  HHK.pages.route = function () {
    ...
    function buildRoute(duration, preference, aiMode) {
      ...
      var tips = [
        ...
        HHK.i18n.text({
          zh: aiMode ? "这条路线综合了热门时段、观景节奏与偏好倾向，更适合想高效游览黄河口的人。" : "可以反复切换偏好和时长，快速找到最适合自己的黄河口节奏。",
          en: aiMode
            ? "This route balances peak moments, viewing rhythm, and your selected preference for an efficient estuary day."
            : "Switch between duration and preference freely to discover the rhythm that suits your trip best."
        })
      ];
    ...
    function generate(aiMode) {
      ...
      if (aiMode) {
        ...
        loader.textContent = HHK.i18n.text({
          zh: "正在为你整合黄河口的热门时段、观景节奏与偏好路线...",
          en: "Curating the best estuary rhythm based on peak moments and your travel preference..."
        });
